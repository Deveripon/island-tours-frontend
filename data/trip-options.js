// Default options data for travel package creation
...
export const tripPackageOptions = {
    ...
    addonCategories: [
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c1d', name: 'Transportation' },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c1e',
            name: 'Accommodation Upgrades',
        },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c1f', name: 'Meal Plans' },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c20',
            name: 'Adventure Activities',
        },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c21',
            name: 'Cultural Experiences',
        },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c22', name: 'Entertainment' },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c23', name: 'Spa & Wellness' },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c24',
            name: 'Photography Services',
        },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c25', name: 'Shopping Tours' },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c26',
            name: 'Insurance & Protection',
        },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c27',
            name: 'Equipment Rental',
        },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c28',
            name: 'Personal Services',
        },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c29',
            name: 'Special Occasions',
        },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c30',
            name: 'Educational Services',
        },
        {
            id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c31',
            name: 'Technology Services',
        },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c32', name: 'Group Services' },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c33', name: 'VIP Services' },
        { id: 'a1d1e1c1-1a1b-1f1e-1d1c-1e1f1a1b1c34', name: 'Seasonal Addons' },
    ],
};

// Move default sections outside component to prevent recreation
export const DEFAULT_SECTIONS = [
    {
        id: 'TitleAndActions',
        name: 'Trip Title and Actions',
        visible: true,
    },
    { id: 'TripHeroGallery', name: 'Trip Hero Gallery', visible: true },
    {
        id: 'TypesAndDifficulty',
        name: 'Types and Difficulty',
        visible: true,
    },
    { id: 'TripSummery', name: 'Trip Summery', visible: true },
    {
        id: 'TourTypesInformation',
        name: 'Tour Types Information',
        visible: true,
    },
    { id: 'TripOverview', name: 'Trip Overview', visible: true },
    { id: 'TripHighlights', name: 'Trip Highlights', visible: true },
    {
        id: 'ItineraryPreview',
        name: 'Itinerary Section',
        visible: true,
    },
    { id: 'whatsIncluded', name: "What's Included", visible: true },
    { id: 'whatsExcluded', name: 'Whats Excluded', visible: true },
    {
        id: 'restrictions',
        name: 'Restrictions',
        visible: true,
    ...
    { id: 'Reviews', name: 'Reviews', visible: true },
