...
export function DestinationActionDropdown({ destination }) {
    const hasEditPermission = useRolePermission(Permission.EDIT_DESTINATION);
                        ...
                        <DropdownMenuItem
                            onClick={() => {
                                document.dispatchEvent(
                                    new CustomEvent('edit-destination', {
                                        detail: destination })
                                );
                            }}
                            className='gap-2 cursor-pointer'>
                ...
                {hasDeletePermission && (
                    <>
                        ...
                        <DropdownMenuItem
                            onClick={() => {
                                document.dispatchEvent(
                                    new CustomEvent('delete-destination', {
