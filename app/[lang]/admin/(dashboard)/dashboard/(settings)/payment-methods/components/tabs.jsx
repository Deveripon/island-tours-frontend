                    ...
                    {formSections?.map(section => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    'flex-shrink-0 flex flex-col items-center gap-2 p-3 rounded-lg transition-all duration-200 min-w-[80px]',
                        ...
                        {formSections?.map(section => {
                            ...
                            return (
                                <button
                                    ...
                                    onClick={() => setActiveTab(section.id)}
                                    className={cn(
                                        'w-full py-[6px] pl-4 rounded-r-none text-left transition-all duration-200 group relative overflow-hidden border-l-6 border-transparent',
                                        isActive
