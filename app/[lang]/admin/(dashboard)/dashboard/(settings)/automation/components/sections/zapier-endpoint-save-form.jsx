...
export default function ZapierWebhookSetup({ existingZapierCatchUrl }) {
    ...
    const webhookConfig = {
        id: 'leads',
        title: 'Push Leads via Zapier',
        icon: 'Zap',
        description:
            'Save catch hooks to push leads through Zapier from your Database',
        instructions: [
    ...
    const handleSaveUrl = async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                toast.success('Zapier URL saved successfully!');
            } else {
                setSaveStatus('error');
                toast.error(
                    ...
                    <div className='border-t border-border pt-6'>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <Button
                                ...
                                disabled={isSaving || !zapierUrl.trim()}
