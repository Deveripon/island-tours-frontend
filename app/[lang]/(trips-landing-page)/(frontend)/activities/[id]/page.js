import { getActivityById } from '@/app/_actions/trips/activityActions';
import { getTripsByActivity } from '@/app/_actions/trips/affiliateTripsAction';
...
const ActivityDetailsPage = async ({ params }) => {
    ...
    const response = await getTripsByActivity(activity?.id);
