...
export async function createCategory(data) {
    if (!data) return { success: false, error: { message: 'Category data is required' } };

    try {
        const responsePromise = fetchWithAuth(`${baseUrl}/trips/categories`, {
            method: 'POST',
...
export async function updateCategory(id, data) {
    ...
    try {
        const responsePromise = fetchWithAuth(`${baseUrl}/trips/categories/${id}`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data)
        });
