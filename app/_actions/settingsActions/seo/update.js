 ...
 * Update Site SEO
 */
export async function updateSiteSeo(data) {
    if (!data) return { success: false, error: { message: 'Data is required' } };

    try {
        const responsePromise = fetchWithAuth(`${baseUrl}/settings/site-seo`, {
            method: 'PATCH',
        ...
        updateTag(`site-seo`);
        revalidatePath('/'); // SEO changes affect meta tags globally
